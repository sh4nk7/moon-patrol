...
class Hole(Actor):
    ...
    def symbol(self):
        return 153 , 140, self._w, self._h
...
h1 = Hole(arena, 100 ,230, -5)
h2 = Hole(arena, 400 ,230, -5)
h3 = Hole(arena, 700 ,230, -5)
h4 = Hole(arena, 900 ,230, -5)

t1 = Tank(arena, 200 ,200, -5)
